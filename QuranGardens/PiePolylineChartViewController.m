...
- (void)setDataCount:(int)count range:(double)range
{
    ...
    for (NSString * key in self.scores.allKeys) {
        [entries addObject:[[PieChartDataEntry alloc] initWithValue:self.scores[key].doubleValue label:key]];
    }
    
    PieChartDataSet *dataSet = [[PieChartDataSet alloc] initWithValues:entries label:@"Results"];
